          ...
          <header>
                      ...
                      <div className="container">
                          <div className="row">
                              <div className="col-lg-10 col-md-10 font-15">
                                  ...
                                  <span> <i className="fas fa-envelope font-12 mr-1"></i><a href={`mailto:${companyOverview.mailid1}`} className="black">{companyOverview.mailid1}</a> </span>
                              </div>  
                  ...
                  <div className="mainNavBar">
                      <div className="container">
                          ...
                          <Img  alt={companyOverview.logo.localFile.title} fixed={companyOverview.logo.localFile.childImageSharp.fixed} />
